...
import LinkingInstance from '../native-common/Linking';
...
export const Animated: RX.Animated = makeAnimated({ ...CommonAnimatedClasses, Text: RNAnimated.createAnimatedComponent(TextComponent) });

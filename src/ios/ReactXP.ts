...
export const GestureView: typeof RX.GestureView = GestureViewComponent;

/**
 * Image Component
 */
export type Image = RX.Image;
export const Image: RX.ImageConstructor = ImageComponent;

/**
 * Input
 */
export type Input = RX.Input;
export const Input: RX.Input = InputInstance;

/**
 * International
 */
export type International = RX.International;
export const International: RX.International = InternationalInstance;

/**
 * Link Component
 */
export type Link = RX.Link;
export const Link: typeof RX.Link = LinkComponent;
